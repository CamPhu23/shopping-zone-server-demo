                        ...
                        <tr>
                            <td style="text-align:center;">
                              <a href="https://rakeshmandal.com" title="logo" target="_blank">
                                <img style="border-radius: 50%" width="150" src="https://res.cloudinary.com/dazdxrnam/image/upload/v1655571126/ShoppingZone/Logo.jpg" title="logo" alt="logo">
                              </a>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                    ...
                                    <tr>
                                        <td style="padding:0 35px;">
                                            <h1>SHOPPING ZONE</h1>
                                            <h2 style="color:#1e1e2d; font-weight:500; margin:0;font-size:32px;font-family:'Rubik',sans-serif;">Chúng tôi nhận được yêu cầu đặt lại mật khẩu từ bạn.</h2>
                                            <span
